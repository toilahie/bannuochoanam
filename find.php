...
<body>
    <nav>
        <label class="logo">PERFUME</label>
        <ul>
    ...
    <div class="left">
        ...
        <div class="left">   
            ...
            <form action="find.php" method="post">
               <input type="text" name="search" value="Nhập tên sản phẩm" onclick="this.value=''"/>
    ...
    <footer>
        ...
        <p class="copyright">PERFUME @ 2022</p>
    </footer>
</body>
